...
The default installation is intended to be similar to the provided Argo CD [releases](https://github.com/nholuongut/argo-cd/releases).
...
In the original [Argo CD repository](https://github.com/nholuongut/argo-cd/) an [`manifests/install.yaml`](https://github.com/nholuongut/argo-cd/blob/master/manifests/install.yaml) is generated using `kustomize`. It's the basis for the installation as [described in the docs](https://argo-cd.readthedocs.io/en/stable/getting_started/#1-install-argo-cd).
...
https://github.com/nholuongut/argo-cd/compare/v1.8.7...v2.0.0#files_bucket

Or you clone the repository and do a local `git-diff`:

```bash
git clone https://github.com/nholuongut/argo-cd.git
cd argo-cd
git diff v1.8.7 v2.0.0 -- manifests/install.yaml
```

Changes in the `CustomResourceDefinition` resources shall be fixed easily by copying 1:1 from the [`manifests/crds` folder](https://github.com/nholuongut/argo-cd/tree/master/manifests/crds) into this [`charts/argo-cd/templates/crds` folder](https://github.com/nholuongut/argo-helm/tree/master/charts/argo-cd/templates/crds).
...
### 6.9.0
ApplicationSet controller is always created to follow [upstream's manifest](https://github.com/nholuongut/argo-cd). 
...
and [code](https://github.com/nholuongut/argo-cd/blob/99723143b96ceec9ef5b0a7feb7b4f4b0dce3497/common/common.go#L252)
...
server:
  additionalApplications:
    - name: guestbook
      ...
      info:
      - name: url
        value: https://github.com/nholuongut/argo-helm/
```
...
With this minor version we introduced the evaluation for the ingress manifest (depending on the capabilities version), See [Pull Request](https://github.com/nholuongut/argo-helm/pull/637).
[Issue 703](https://github.com/nholuongut/argo-helm/issues/703) reported that the capabilities evaluation is **not handled correctly when deploying the chart via an Argo CD instance**,
...
This option uses the following third-party chart to bootstrap a clustered Redis: https://github.com/nholuongdevops/charts/tree/master/charts/redis-ha.
...
[v2.2 to 2.3 upgrade instructions]: https://github.com/nholuongut/argo-cd/blob/v2.3.0/docs/operator-manual/upgrading/2.2-2.3.md
[tini]: https://github.com/nholuongut/argo-cd/pull/12707
